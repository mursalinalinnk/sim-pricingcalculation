...
$sql_ngambil_user = mysql_query( "SELECT * FROM tb_admin WHERE nama_admin = '$_SESSION[username]' ");
...
<div class="container">
	...
	<a class="navbar-brand" href="index.php">PERUSAHAAN OWNER <?php echo $user->nama_admin;?></a>
