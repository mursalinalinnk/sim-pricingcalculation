		...
		<div class="col-md-6">
			...
			<table>
				...
				<div class="form-group">
					...
					<input type="submit" class="btn btn-outline btn-success" name="tambahpend" value="tambah">
					<input type="submit" class="btn btn-outline btn-success" name="hapuspend" value="hapus">
		...
		<div class="col-md-6">
			...
			<table>
				...
				<div class="form-group">
					...
					<input type="submit" class="btn btn-outline btn-primary" name="tambahtab" value="tambah">
					<input type="submit" class="btn btn-outline btn-primary" name="hapustab" value="hapus">
					<input type="reset" class="btn btn-outline btn-primary">
			</form>
		</div>
		</div>
		<!-- /row -->
